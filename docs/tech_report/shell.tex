...
Improved shellsort should have a slighlty lower instruction count, and hence a
...
instruction count}, \ref{shell level 1 misses} and \ref{shell branch
mispredictions}. It performs better than a
...
seen in Figure \ref{shell cycle count}.

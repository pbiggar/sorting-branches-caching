...
3 %TODO does this mean that knuths harmonics applies to this sort of prediction
% thing TODO
...
Figure \ref{base and memory-tuned heapsorts-1}(a) shows the behaviour of each
...
%TODO read over the merged bits. might not be quite right

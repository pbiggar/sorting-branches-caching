...
8-heap. The difference between fully associative and direct mapped is only
minor, with the fully associative performing slightly better than the direct
mapped cache.
...
\sixplot{base_heapsort_0.eps}{cache4_heapsort_0.eps}{cache_heapsort_0.eps}{cache_heapsort_1.eps}{}{}{base and cache heapsorts}

...
double tiled sorts perform significantly better than the unoptimized sorts.
...
not identical, due to different \c{int} sizes in our tests.
...
is used instead.
%TODO ohw much better does this do? if not, move to other section

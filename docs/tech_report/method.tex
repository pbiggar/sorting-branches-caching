...
%TODO this is going to have to be updated - or is it
\begin{figure}
...
\subsection{Gnuplot}
\label{Gnuplot}
\cc{Gnuplot} is a tool for plotting data files. It provides visualisations of
...
%TODO this bit also has to be checked once we fix mergesort. if w fix mergesort
...
random data from \n{http://www.random.org}. The software predictor used ten
sections containing 4194304 \cc{unsigned integer}s, and the SimpleScalar
...
%TODO did i say 128 byte elsewhere?
...
LaMarca used 64-bit \cc{integer}s, as his test machine was a 64-bit system.

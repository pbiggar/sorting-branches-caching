...
\subsection{}
simplescalar version and settings used
...
cache line length. - vs pentium 4

penitum 4:
1.8, 8-way 256K level 2 64 byte line (note i wrote 128 byte xsomewhere. is this
right)
4-way 8kb level 1 cache

branch delay 20 cycles


1.8GHz machine, which has an 8-way associative 256KB level 2 cache with a 64 byte

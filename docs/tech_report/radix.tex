...
number of level 2 misses. We adapt this strategy here, and call it Aligned Cache
Radixsort.
...
does. As shown in Figure \ref{radix cycles}, memory-tuned radixsorts performance is

...
2-level adpative ones in almost every case in this research. This holds across
...
increase is actual running time due to branch mispredictions is significant.

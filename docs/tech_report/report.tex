...
removing the need for a sentinel in heapsort. Overall, we found that a
cache-optimized radixsort was the fastest algorithm for all large arrays; the
absence of comparison branches means that the algorithm causes almost no branch
mispredictions.

...
The figure shows that the base heapsort performs best while the data set fits in
...
The most interesting thing is the relation between the predictivity of the

...
void double_aligned_mergesort(unsigned int a[], int N); /* level 1, level 2, then continue merging */
void double_aligned_multi_mergsort(unsigned int a[], int N); /* level 1, level 2, then k-way mere using heapsort */

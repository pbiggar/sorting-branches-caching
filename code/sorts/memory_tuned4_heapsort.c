...
void
memory_tuned4_heapsort(unsigned int a[], int N)
{
	...
	describe_predictor(&global_predictor[5], "child promotion");
	describe_predictor(&global_predictor[6], "fix up");
	...
	/* a memcpy might fo this faster, but may have worse cacheness(although i doubt this) */
